...
def function(X1, X2, X3):
    y = 9.6 + 8.9 * X1 + 8.6 * X2 + 2.6 * X3 + 6.4 * X1 * X1 + 0.8 * X2 * X2 + 7.2 * X3 * X3 + 7.9 * X1 * X2 + \
        0.8 * X1 * X3 + 9.8 * X2 * X3 + 8.0 * X1 * X2 * X3 + randrange(0, 10) - 5
    return y
...
for j in range(11):
    ...
    if fabs(t_pract / sbs) < t.ppf(q=0.975, df=F3):
        ...
        end_time = perf_counter() - time3
    search_time += time1 + end_time
if float(search_time) > 0.1:
